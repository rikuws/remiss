...
pub use lsp_notice::LspStatusNotice;
...
pub struct AppState {
    ...
    pub diagnostic_export_loading: bool,
    pub diagnostic_export_message: Option<String>,
    pub diagnostic_export_error: Option<String>,
    ...
    pub file_chooser_query: String,
    pub file_chooser_selected_index: usize,
    pub file_chooser_list_state: ListState,
...
impl AppState {
    pub fn new(cache: CacheStore, startup_wizard_options: StartupWizardOptions) -> Self {
        ...
        let mut state = Self {
            ...
            diagnostic_export_loading: false,
            diagnostic_export_message: None,
            ...
            file_chooser_query: String::new(),
            file_chooser_selected_index: 0,
            file_chooser_list_state: ListState::new(0, ListAlignment::Top, px(48.0)),
