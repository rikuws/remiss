...
mod local_git_actions;

pub(crate) use local_git_actions::{
    trigger_commit_local_changes, trigger_push_local_branch, trigger_stage_all_local_changes,
    trigger_stage_local_file, trigger_unstage_all_local_changes, trigger_unstage_local_file,
};
...
async fn inspect_and_open_local_review(
    ...
    match result {
        Ok(inspection) => {
            ...
            let local_change_status = inspection.local_change_status.clone();
            ...
            model
                .update(cx, |state, cx| {
                    ...
                    detail_state.local_change_status = Some(local_change_status.clone());
                    detail_state.local_git_operation = Default::default();
        ...
        .when(repositories.is_empty(), |el| {
            el.child(
                div()
                    ...
                    .line_height(px(15.0))
                    .text_color(fg_muted())
                    .child("Add a working checkout to review, commit, and push local changes."),
            )
        })
